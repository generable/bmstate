...
simdat$paths$subject_df$dose_amt <- simdat$paths$subject_df$dose
simdat_death <- as_single_event(simdat$paths, "Dead", null_state = "Healthy")
...
ttd <- simdat_death$transition_times()
...
fit_ms_dh <- fit_stan(mod_ms_dh, simdat, method = "optimize", init = 0)
